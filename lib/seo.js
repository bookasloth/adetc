...
// Default OG image. ponytail: reuse the logo until a 1200x630 card ships (W2).
export const DEFAULT_OG_IMAGE = '/assets/images/adetc-logo.png';
...
export const PAGE_META = {
  '/': {
    ...
    title: { absolute: 'adetc — Film & Video Production Studio in Ahmedabad' },
    description:
...
export function buildMetadata(path, overrides = {}) {
  ...
  const images = overrides.images || [DEFAULT_OG_IMAGE];
  return {
    title,
    description,
